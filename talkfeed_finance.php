 ...
 <!-- Header -->
    ...
    <!-- Title -->        
            ...
            <div id="header-title">
                ...
                <div id="header-center-title"><h2>Feed | Finance</h2></div>
...
<div class="cmt-container" >
    ...
    $sql = mysql_query("SELECT * FROM finance WHERE id_post = '$id_post'") or die(mysql_error());;
   ...
   $(function(){ 
        ...
        $('.bt-add-com').click(function(){
            ...
            if( !theCom.val()){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax/add-comment_finance.php",
